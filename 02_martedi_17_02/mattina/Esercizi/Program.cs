...
class Program
{
    ...
    {
        /* -somma di due numeri: dichiarare due variabili di tipo int, assegnare loro dei valori,
         sommarle e stampare il risultato*/
         int numeroA = 78;
         int numeroB = 24;
         Console.WriteLine("la somma di numeroA e numeroB è " + numeroA + numeroB);

         /* -calcolo di un prezzo scontato: crea una variabile double per il prezzo originale
          e applica uno sconto del 20%, stampando il prezzo finale*/
         double prezzo = 20.6d;
         double sconto = 0.20d;
         double prezzoScontato = prezzo - (prezzo * sconto);
         Console.WriteLine("il prezzo scontato è " + prezzoScontato);

         /*-controllo di un numero positivo: dichiara una variabile float e 
         usa un'espressione di comparazione per verificare se il numero è positivo. 
         visualizza il risultato booleano */
        ...
        chiedi all'utente un numero intero e un numero con la virgola esegui 
        la somma tra due numeri e stampa*/
        ...
        /*età e altezza con casting, chiedi l'età all'utente e la sua altezza,
         esegui la somma tra età e altezza in metri (float) convertita in int*/
